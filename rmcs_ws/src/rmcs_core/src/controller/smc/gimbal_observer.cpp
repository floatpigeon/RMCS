...
public:
    GimbalObserver()
        ...
        register_input("/gimbal/yaw/control_angle_error", yaw_angle_error_);
        register_input("/gimbal/yaw/velocity_imu", yaw_velocity_);

        register_output("/gimbal/yaw/expect_velocity", yaw_expect_velocity_);
        register_output("/gimbal/yaw/expect_acceleration", yaw_expect_acceleration_);
    }
